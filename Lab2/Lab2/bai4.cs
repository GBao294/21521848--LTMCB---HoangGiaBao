...
namespace Lab2
{
    ...
    public partial class bai4 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (phone.Text.Length != 10 || !phone.Text.StartsWith("0"))
            {
            ...
            if (Convert.ToInt32(c1) < 0 || Convert.ToInt32(c1) > 10 || Convert.ToInt32(c2) < 0 || Convert.ToInt32(c2) > 10 || Convert.ToInt32(c3) < 0 || Convert.ToInt32(c3) > 10)
            {
